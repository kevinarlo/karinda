                                    ...
                                    <ul class="dropdown">
                                        <li><a href="#">Subsidy</a>
                                            <ul class="dropdown">
                                                ...
                                                <li><a href="gallery_subsidy_adimix.php">ADIMIX</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Commercial</a>
                                            <ul class="dropdown">
                                                <li><a href="gallery_commercial_kbn.php">KBN</a></li>
                                                <li><a href="gallery_commercial_adimix.php">ADIMIX</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
...
$tampil="SELECT * FROM product where id_kategori = '1'"; 
                        ...
                        <div class="table-responsive table-borderless">
                            <table class="table table-hover">
                                <tbody>
                                    <tr >
                                        <td>
                                        <img src="picture/subsidy_kbn/<?php echo $f;?>" width="100%" onclick="window.location = 'simpantransaksi.php?id_produk=<?php echo $a;?>';"/></td>
                                        <td style="width: 30%; font-size: "32px;">
                                            <b style="font-size: 18px;"><?php echo $b;?></b>
                                        <br><br>
                                        <i style="font-size: 13px;">Harga Jual&nbsp;Rp. <?php echo $d;?></i>
                                        <br><br>
                                        <i style="font-size: 13px;">&nbsp;<?php echo $g;?></i>
                                        <br><br>
                                        <i style="font-size: 13px;">Tipe :&nbsp;<?php echo $c;?></i>
                                        <br>
                                        <i style="font-size: 13px;">Kamar Tidur :&nbsp;<?php echo $h;?></i>
                                        <br>
                                        <i style="font-size: 13px;">Kamar Mandi :&nbsp;<?php echo $i;?></i>
                                        <hr style="color: black" width=75% Size="100">
                                        <p style="font-size: 13px; color: #947054;">Karinda Bangun Nusa
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
