...
?>
                    ...
                    <div class="col-lg-10">
                        <!-- Single Slide -->
                  <div class="featured-properties-slides" data-wow-delay="350ms">

                        <!-- Single Slide -->
                        <div class="single-featured-property">
                            <!-- Property Thumbnail -->
                            <div class="property-thumb">
                                <img src="../picture/subsidy_kbn/KBN1.jpg" alt="" width="320px">
                            </div>
                        </div>
                        ...
                        <div class="single-featured-property">
                            <!-- Property Thumbnail -->
                            <div class="property-thumb">
                                <img src="../picture/subsidy_kbn/KBN2.jpg" alt="" width="320px">
                            </div>
                        </div>
            </div>
