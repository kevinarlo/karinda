...
$kd=mysql_query("SELECT id FROM blogger WHERE id");
...
<table style="width: 600px;margin:auto;background: #e6e6e6;padding: 20px;">
    <form action="simpanblog.php" enctype="multipart/form-data" method="POST" name="form1" id="form1">
    <fieldset>
    ...
    <fieldset>
    <label>Images</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="file" id="namaf" name="namaf" />
      <br>
      <label>Date Post &nbsp;</label>
      <input type="text" id="tanggal" name="tanggal" placeholder="yyyy-mm-dd" />
    </fieldset>
    <fieldset>
      <label>Post</label>
