...
<head>
    ...
    <!-- Title  -->
    <title>PT Karinda Bangun Nusa | Contact</title>
                ...
                <div class="col-12 col-lg-4">
                    <div class="content-sidebar">
                        ...
                        <div class="address mt-30">
                            ...
                            <h6><img src="img/icons/envelope.png" alt=""> karindabangunnusa0@gmail.com</h6>
                            <h6><img src="img/icons/location.png" alt=""> Jl. Syech Quro, Perkantoran Johar Indah Ruko No. A10<br>Karawang Timur, 41314</h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-8">
                    <div class="contact-form">
                        <form id="form1" name="form1" method="post" action="simpanpesan.php">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="nomor telepon" id="nomor_telepon" placeholder="Your Phone">
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control" name="email" id="email" placeholder="Your Email">
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" name="pesan" id="pesan" cols="30" rows="10" placeholder="Your Message"></textarea>
                            </div>
