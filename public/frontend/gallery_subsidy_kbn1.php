...
<!-- Title  -->
    <title>PT Karinda Bangun Nusa | Detail</title>
...
<body>
    ...
    <section class="hero-area">
           <!-- Single Hero Slide -->
            <div class="breadcumb-area bg-img" style="background-image: url(picture/subsidy_kbn/BSI12.jpg);">
            </div>
        </div>
    </section>
    <!-- ##### Hero Area End ##### -->
...
$koneksi=mysql_connect("localhost","root","")or die(mysql_error()); 
mysql_select_db("kbn_db"); 
$tampil="SELECT * FROM rincian_biaya where id_kategori"; 
$query=mysql_query($tampil) or die ("gagal".mysql_error());
?>
<?php
while ($row=mysql_fetch_array($query))
...
$koneksi=mysql_connect("localhost","root","")or die(mysql_error()); 
mysql_select_db("kbn_db"); 
$tampil="SELECT * FROM estimasi_angsuran where id_kategori"; 
$query=mysql_query($tampil) or die ("gagal".mysql_error());
?>
<?php
while ($row=mysql_fetch_array($query))
 {
   ...
   $eeee=$row['suku_bunga'];
   $ffff=$row['keterangan'];
   $gggg=$row['id_kategori'];
?>

<!-- ##### Featured Properties Area Start ##### -->

<div class="area section-padding-100-50">    
<section class="col-lg-12">
<div class="col-sm-8-lg-12">
<div class="product-slider">
  <div id="carousel" class="carousel slide" data-ride="carousel" data-interval="false">
    <div class="carousel-inner">
      <div class="item active"> <img src="picture/subsidy_kbn/BSI1.jpg"> </div>
      <div class="item"> <img src="picture/subsidy_kbn/BSI2.jpg"> </div>
      <div class="item"> <img src="picture/subsidy_kbn/BSI3.jpg"> </div>
      <div class="item"> <img src="picture/subsidy_kbn/BSI4.jpg"> </div>
      <div class="item"> <img src="picture/subsidy_kbn/BSI5.jpg"> </div>
      <div class="item"> <img src="picture/subsidy_kbn/BSI6.jpg"> </div>
      <div class="item"> <img src="picture/subsidy_kbn/BSI7.jpg"> </div>
      <div class="item"> <img src="picture/subsidy_kbn/BSI8.jpg"> </div>
    </div>
  </div>
  <div class="clearfix">
    <div id="thumbcarousel" class="carousel slide" data-interval="false">
      <div class="carousel-inner">
        <div class="item active">
          <div data-target="#carousel" data-slide-to="0" class="thumb"><img src="picture/subsidy_kbn/BSI1.jpg"></div>
          <div data-target="#carousel" data-slide-to="1" class="thumb"><img src="picture/subsidy_kbn/BSI2.jpg"></div>
          <div data-target="#carousel" data-slide-to="2" class="thumb"><img src="picture/subsidy_kbn/BSI3.jpg"></div>
          <div data-target="#carousel" data-slide-to="3" class="thumb"><img src="picture/subsidy_kbn/BSI4.jpg"></div>
        </div>
        <div class="item">
          <div data-target="#carousel" data-slide-to="4" class="thumb"><img src="picture/subsidy_kbn/BSI5.jpg"></div>
          <div data-target="#carousel" data-slide-to="5" class="thumb"><img src="picture/subsidy_kbn/BSI6.jpg"></div>
          <div data-target="#carousel" data-slide-to="6" class="thumb"><img src="picture/subsidy_kbn/BSI7.jpg"></div>
          <div data-target="#carousel" data-slide-to="7" class="thumb"><img src="picture/subsidy_kbn/BSI8.jpg"></div>
        </div>
      </div>
      <!-- /carousel-inner --> 
                            ...
                            <table class="table table-hover">
                                <tbody> 
                                    <tr >
                                        ...
                                        Rincian Biaya&nbsp;</a>
                                        <br><br>
                                        <a style="font-size: 18px;">Harga Jual&nbsp;:&nbsp;Rp. <?php echo $bbb;?></a>
                                        <br><br>
                                        <a style="font-size: 18px;">
                                        Booking fee&nbsp;:</a>
                                        <a style="font-size: 18px;">&nbsp;&nbsp;Rp. <?php echo $ccc;?></a>
                                        <br><br>
                                        <a style="font-size: 18px;">
                                        Uang Muka&nbsp;:</a>
                                        <a style="font-size: 18px;">&nbsp;:&nbsp;Rp. <?php echo $ddd;?></a>
                                        <br><br>
                                        <a style="font-size: 18px;">
                                        Flapod KPR&nbsp;:</a>
                                        <a style="font-size: 18px;">&nbsp;:&nbsp;Rp. <?php echo $eee;?></a>
                                        <br><br>
                                        ...
                                        <br><br>
                                        <a style="font-size: 18px;">10 TH&nbsp;:&nbsp;Rp. <?php echo $bbbb;?></a>
                                        <br><br>
                                        <a style="font-size: 18px;">15 TH&nbsp;:&nbsp;Rp. <?php echo $cccc;?></a>
                                        <br><br>
                                        <a style="font-size: 18px;">20 TH&nbsp;:&nbsp;Rp. <?php echo $dddd;?></a>
                                        <br><br>
                                        <a style="font-size: 18px;">Suku Bunga&nbsp;:&nbsp;Rp. <?php echo $eeee;?></a>
                                        <br><br>
                                        <a style="font-size: 18px;">Keterangan&nbsp;:&nbsp;Rp. <?php echo $ffff;?></a>
                                        <br><br>
