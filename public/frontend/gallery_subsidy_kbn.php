...
<head>
    ...
    <!-- Title  -->
    <title>PT Karinda Bangun Nusa | Subsidy</title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="contact-heading">
                        <h6>Gallery Subsidy</h6>
                    </div>
                    <div class="section-heading wow fadeInUp">
                        <h2>Subsidy Karinda Bangun Nusa</h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="table-responsive table-borderless">
                            <table class="table table-hover">
                                <tbody style="cursor: pointer;"> 
                                    <tr>
                                        <td>
                                        <a href="gallery_subsidy_kbn1.php"><img src="picture/subsidy_kbn/BSI1.jpg" width="100%"></td>
                                        <td style="width: 30%; font-size: "32px;">
                                            <b style="font-size: 18px;">BUMI SUKASARI INDAH</b>
                                        <br><br>
                                        <i style="font-size: 14px;">Harga Jual&nbsp;Rp.140.000.000</i>
                                        <br><br>
                                        <i style="font-size: 14px;">
                                        &nbsp;Jl. Sukasari, Kec. Purwasari, Kabupaten Karawang, Jawa Barat 41373</i>
                                        <br><br>
                                        <i style="font-size: 14px;">Unit Ready :&nbsp;330</i>
                                        <br>
                                        <i style="font-size: 14px;">Unit Sold :&nbsp;566</i>
                                        <br><br>
                                        <i style="font-size: 14px;">Tipe :&nbsp;30/60</i>
                                        <br>
                                        <i style="font-size: 14px;">Kamar Tidur :&nbsp;2</i>
                                        <br>
                                        <i style="font-size: 14px;">Kamar Mandi :&nbsp;1</i>
                                        <br><br>
                                        <hr style="color: black" width=75% Size="100">
                                        <p style="font-size: 14px; color: #947054;">Karinda Bangun Nusa</p></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
